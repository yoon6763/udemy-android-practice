...
open class CardMemberListItemsAdapter(
    ...
    class MyViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        val iv_selected_member_image = view.findViewById<ImageView>(R.id.iv_selected_member_image)
        val  iv_add_member = view.findViewById<ImageView>(R.id.iv_add_member)
    }
}