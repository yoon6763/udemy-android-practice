...
open class CardListItemsAdapter(
    ...
    class MyViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        val view_label_color = view.findViewById<TextView>(R.id.view_label_color)
        val tv_card_name = view.findViewById<TextView>(R.id.tv_card_name)
        val rv_card_selected_members_list = view.findViewById<RecyclerView>(R.id.rv_card_selected_members_list)
    }
}